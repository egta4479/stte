...
class LectureController extends Controller
{
	...
	public $mandatories=array ( 0 => 'optional', 1 => 'must' );
	/**
	 ...
	 * Manages all models.
	 */
	protected function checkMandatory($data,$row)
    {
       return $data->ismandatory != '0' ? 'must' : 'optional';            
    }
    protected function checkDay($data,$row)
    {
       return $this->days[$data->day];            
    }
