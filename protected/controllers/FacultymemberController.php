...
class FacultymemberController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Facultymember');
	 ...
	 * @return Facultymember the loaded model
	 ...
	 * @param Facultymember $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='facultymember-form')
		{
